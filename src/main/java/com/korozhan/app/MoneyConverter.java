...
public class MoneyConverter {
    ...
    public static String digits2text(Double amount, String currencyString) {
        ...
        if (amount == null || amount < 0.0 || amount > 1000000.0 || n > 3) {
            //Пока гарантированно преобразуются лишь числа от 0.0 до 1000000.0
            return null;
        }
        if (n == 2) {
            s += "0";
        ...
        switch (sa[1].charAt(1)) {
            case '1':
                if (currency == Currency.BYN) {
                    ...
                    result.append(sa[1].charAt(0) != '1' ? "цент" : "центов");
                }
                break;
            case '2':
            case '3':
            case '4':
                if (currency == Currency.BYN) {
                    ...
                    result.append(sa[1].charAt(0) != '1' ? "цента" : "центов");
                }
                break;
            default:
                if (currency == Currency.BYN) {
